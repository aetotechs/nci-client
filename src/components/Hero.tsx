...
function Hero() {
  return (
    <div className=" grid grid-rows-2    md:flex md:my-20 h-[646px]  md:h-[300px]  md:justify-between   rounded-r-3xl id='home ">
      <div className="md:mb-5  md:my-0 h-[322px] lg:h-[300px]  md:w-[568px] md:pr-20 order-last md:order-first  ">
      ...
      <div className="md:w-[622px] md:h-[380px]  w-[340px] h-[300px] bg-hero bg-cover bg-center rounded-2xl md:rounded-3xl"></div>
    </div>
  );
}
