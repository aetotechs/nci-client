...
function Hero() {
  return (
    <div
      className="flex flex-col gap-6 md:flex-row   md:mt-20 py-6 md:mb-24   md:py-3  rounded-r-3xl"
      id="home"
    >
      <div className="order-last md:order-first w-full md:w-[45vw]   md:p-0 rounded-lg">
        ...
        <p className="leading-[28px] font-normal text-[17px] md:text-[20px] md:leading-[30px] mt-4">
