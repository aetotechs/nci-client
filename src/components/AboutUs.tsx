...
function AboutUs() {
  return (
    <div className="my-12 py-6 rounded-2xl px-4 md:flex md:p-10 md:gap-[3vw] bg-white  md:mb-24" id="about">
      ...
      <div className="w-full md:w-[50%] flex flex-col justify-center">
        <h3 className="font-semibold text-xl leading-8 md:text-[26px] md:leading-[30px]">About Us</h3>
        <p className="text-base mb-6 mt-2 font-normal leading-6 md:text-[18px] md:leading-[30px]">
          ...
          <br /> From the heart of Africa&apos;s coffee regions to
          your cup...
        </p>
