        ...
        <div className="flex flex-col gap-7 md:flex-row ">
          <div className="bg-white md:h-[480px] md:w-[600px] p-5">
            ...
            <p className="font-normal text-base mb-5 leading-7 text-inactive">
              ...
              flavor. Our fair relationships support communities and promote sustainable farming. At
              Nile Coffee Imports, we believe great coffee tells a story of dedication and
              craftsmanship. Join us in experiencing the rich flavors and vibrant culture of our
              coffee, from source to cup.
            </p>
            <Button variant="outline" className="border border-primary my-4 bg-white text-primary">
              Contact us
            </Button>
          </div>
          <div className="md:w-[600px] md:h-[631px] flex flex-col gap-5">
            ...
            <div className="bg-white h-[300px] p-5 rounded-[20px] flex flex-col gap-4 md:grid  md:grid-cols-2 md:gap-1 md:h-[202px] md:p-5">
              <div className="col-span-2 h-[70px] bg-primary text-white rounded-[10px] flex justify-center items-center">
                Quality
              </div>
              <div className="h-[70px] bg-primary text-white rounded-[10px] flex justify-center items-center">
                Sustainability
              </div>
              <div className="h-[70px] bg-primary text-white rounded-[10px] flex justify-center items-center">
