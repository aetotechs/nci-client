  ...
  <div className=" justify-center flex items-center min-h-screen ">  
    ...
    <div className="w-[90%] flex flex-col items-center my-1  border rounded-xl  justify-center py-5 md:w-[500px]  ">
        ...
        <div className="mb-4">
            ...
            <p className=" text-center font-normal text-sm">Create an account or login to access exclusive account benefits</p>
        </div>
        <div className=" w-full px-10 py-5">
        <Tabs defaultValue="login">
  <TabsList className=" h-[40px]  mb-4 rounded-xl  bg-tab ">
    <TabsTrigger value="login" className="py-2 font-normal text-base w-[200px] ">Login</TabsTrigger>
    <TabsTrigger value="signup" className="py-2 w-[200px]">SignUp</TabsTrigger>
  </TabsList>
