    ...
    <>
        ...
        <div className="mt-16 text-gray-800 lg:px-[4vw] md:px-[2vw] md:max-w-[100vw]">
            <div className="mx-auto shadow-md rounded-md p-8">
                ...
                <p className="mb-4">
                Welcome to Nile Coffee Imports. By accessing or using our website, you
                ...
                <p className="mb-4">
                All content on this site is the property of Nile Coffee Imports.
                Reproduction without permission is prohibited.
                </p>
                <h2 className="text-xl font-semibold mt-6">3. Limitation of Liability</h2>
                <p>
                Nile Coffee Imports is not liable for any damages arising from your
                use of this website.
                </p>
            </div>
        </div>
