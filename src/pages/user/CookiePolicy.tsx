    ...
    <>
        ...
        <div className="mt-16 text-gray-800 lg:px-[4vw] md:px-[2vw] md:max-w-[100vw]">
            <div className="mx-auto shadow-md rounded-md p-8">
                ...
                explains their purpose and how you can manage them.
                </p>
                <h2 className="text-xl font-semibold mt-6">1. What Are Cookies?</h2>
                <p className="mb-4">
                Cookies are small files stored on your device to remember preferences
                and enhance functionality.
                </p>
                <h2 className="text-xl font-semibold mt-6">2. How We Use Cookies</h2>
                <p className="mb-4">
                We use cookies for analytics, personalized content, and marketing
                purposes.
                </p>
