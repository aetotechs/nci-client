    ...
    <>
        ...
        <div className="mt-16 text-gray-800 lg:px-[4vw] md:px-[2vw] md:max-w-[100vw]">
            <div className="mx-auto shadow-md rounded-md p-8">
                ...
                <p className="mb-4">
                Nile Coffee Imports values your privacy. This policy explains how we
                collect, use, and protect your information.
                </p>
                <h2 className="text-xl font-semibold mt-6">1. Information Collection</h2>
                <p className="mb-4">
                We collect personal information you provide when registering or
                purchasing from our site.
                </p>
                <h2 className="text-xl font-semibold mt-6">2. Use of Information</h2>
                <p className="mb-4">
                Your information is used to process orders, improve services, and
                communicate updates.
                </p>
                <h2 className="text-xl font-semibold mt-6">3. Security</h2>
                <p>
                We employ security measures to protect your data. However, no online
