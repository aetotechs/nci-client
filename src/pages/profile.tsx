...
function Profile({ status }: IStatus) {
  ...
  return (
    <div className="max-w-full overflow-hidden ">
      <div className="mb-10 md:my-10 mx-auto max-w-[100vw] overflow-hidden md:w-[1232px]">
        ...
        <div className="flex  md:justify-between px-3 md:px-0   md:my-5 py-5">
            ...
            <div className="flex px-3 md:px-0 md:w-[311px] w-[100vw] overflow-x-auto md:overflow-hidden bg-white md:p-5 rounded-[8px]">
              <div className="flex md:flex-col md:px-4 gap-6">
                ...
                <div
                  ...
                  className={`${activeLink === 'Password and Security' ? 'text-primary w-[295px] md:w-[275px] h-[38px] border-l-4 px-2 py-2 border-primary bg-outline font-medium ' : 'font-normal'} text-base cursor-pointer`}
                >
                ...
                <div
                  ...
                  className={`${activeLink === 'Addresses' ? 'text-primary w-[275px] h-[38px] border-l-4  py-2 px-5 border-primary bg-outline font-medium ' : 'font-normal'} text-base cursor-pointer px-5 py-2 md:px-0 `}
                >
                  Addresses
                </div>
                <div
                ...
                <div className="text-red-500 cursor-pointer font-normal text-base">Log Out</div>
              </div>
            </div>
          </div>
